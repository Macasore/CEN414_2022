    ...
    $.extend(simpleCart.prototype, {
        ...
        _setupCart: function () {
            ...
            this.cart_ele.append(
                "<div class='panel-heading cart-heading'><div class='total-cart-count'>Your Cart 0 items</div><div class='spacer'></div><i class='fa fa-dollar total-cart-cost'>0</i><div></div></div>"
            );
            this.cart_ele.append(
            ...
            for (var i in cartArray) {
                output +=
                    ...
                    " name='number'>\n\
                       ...
                       <div class='quantity-am'><i class='fa fa-dollar'>" +
                    cartArray[i].price +
                    "</i></div>\n\
                       </div>";
            }
